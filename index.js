...
const {
  DISCORD_TOKEN, CLIENT_ID, PORT,
  VERIFICATION_CHANNEL_ID, VERIFIED_ROLE_ID, VERIFY_LOG_CHANNEL_ID,
  JOIN_CHANNEL_ID, JOIN_GUILD_ID,
  BOOST_CHANNEL_ID,
  SUGGEST_CATEGORY_ID,
  CLOUDFLARE_SECRET
} = process.env;
...
/////////////////////
// Interaction (Tickets & Verification)
/////////////////////
